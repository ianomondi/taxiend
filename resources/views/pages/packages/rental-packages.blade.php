                ...
                <div class="content-wrapper">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="content-header-title mb-0 d-inline-block"><i class="fas fa-car"></i> Rental Packages</h3>
                                                        <div class="btn-group float-md-right">
                                    <div class="heading-elements">
                                        <button type="button" class="btn btn-icon btn-success mr-1"
                                                title="Add Package" data-toggle="modal"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <label class="modal-title text-text-bold-600"
                               id="myModalLabel33"><b>Add Package                            (You are adding in EN)</b></label>
                        ...
                        <input type="hidden" name="_token" value="Wf9RDzSMNzEpkN8T2X8IJgT4wEstdnNYpf3ENoj6">                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="name" name="name"
                                       placeholder="Please Enter Package Name" required>
                            </div>
                            ...
                            <div class="form-group">
                                <textarea class="form-control" id="terms_conditions" name="terms_conditions" rows="3"
                                          placeholder="Please Enter Terms & Conditions"></textarea>
                            </div>
                        </div>
