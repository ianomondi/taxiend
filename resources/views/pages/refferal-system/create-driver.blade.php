...
@include('sub-views.sidenav')
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <script>
            function show_div(that){
                var div_value = that.value;
                if(div_value == 1){
                    $("#show_hide").hide();
                }else if(div_value == 2){
                    $("#show_hide").show();
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="btn-group float-md-right">
                                                <a href="/refferal-system/driver-system">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control required" onchange="return show_div(this);" name="offer_type"
                                                                            id="offer_type"
                                                                            required>
                                                                        <option selected  disabled>Choose Refer Type</option>
                                                                        <option value="1">Commission Compensation</option>
